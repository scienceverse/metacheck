...
In this study we examine whether automated checks reduce the amount of errors that researchers make in scientific manuscripts. This study was preregistered at https://osf.io/48ncu and on AsPredicted at https://aspredicted.org/by8i8v.pdf.
...
We conducted a sensitivity power analysis to determine that a Cohen's d of `r d` is the smallest effect size that we could detect with N = 50 participants in each group and 80% power.

## Results

We simulated the data using Faux [@faux] (@fig-sim).
