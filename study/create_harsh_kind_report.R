...
report_harsh(paper,
       modules = c("C:/Users/dlakens/OneDrive - TU Eindhoven/git_repos/metacheck/inst/modules/stat_effect_size_harsh.R",
...
report_kind(paper,
             modules = c("C:/Users/dlakens/OneDrive - TU Eindhoven/git_repos/metacheck/inst/modules/stat_effect_size_kind.R",
