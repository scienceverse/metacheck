...
load_tab <- tabItem(
  ...
  p("Use `convert_grobid()` to create XML files from PDFs. This relies on an external or local grobid server, and will save files to your machine, so needs to run outside this app."),
