...
stat_p_nonsig <- function(paper) {
  ...
  if (tl == "green") {
    ...
    summary_text <- sprintf(
      "We found %d non-significant p value%s that should be checked for appropriate interpretation. You might want to review these to see if improvements can be made.",
