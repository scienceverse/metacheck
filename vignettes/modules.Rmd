...
The machine learning aspect of papercheck is under development, but currently uses BERT models to classify text. The "ml" key takes a dictionary of the arguments to `ml()`, with an additional optional setting to filter the output table to only matching responses.
