...
```{r}
mo <- module_run(psychsci[1:10], "effect_size")
...
![](effect-size-plot.png){fig.alt="Plot of average percentage of t-test that are missing effect sizes. The x-axis shows years form 2014 to 2024 and the y-axis shows Average % missing. Theree is a fairly stead downward trend from 60% in 2014 to around 20% by 2021."}
