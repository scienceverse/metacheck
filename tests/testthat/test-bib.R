...
test_that("bibsearch", {
  ...
  authors <- "Lakens, D"
  # expect_message(b <- bibsearch(title, source, authors)) DOES NOT FAIL ON LAKENS
...
test_that("bibtex_add_dois", {
  ...
  # expect_message(strict <- bibtex_add_dois(bibfile, save_to))  DOES NOT FAIL ON LAKENS
  ...
  # expect_message(nostrict <- bibtex_add_dois(bibfile, save_to, strict = FALSE))  DOES NOT FAIL ON LAKENS
  # expect_true(file.exists(save_to))
...
test_that("bib_add_dois", {
  ...
  # expect_message(bib_strict <- bib_add_dois(bib))  DOES NOT FAIL ON LAKENS
  # expect_message(bib_nostrict <- bib_add_dois(bib, strict = FALSE))  DOES NOT FAIL ON LAKENS
