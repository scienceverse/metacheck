structure(list(url = "https://api.osf.io/v2/nodes/yt32c/children/", 
    ...
    0x7d)), date = structure(1755448299, class = c("POSIXct", 
    "POSIXt"), tzone = "GMT"), times = c(redirect = 0, namelookup = 0, 
    connect = 0, pretransfer = 9.7e-05, starttransfer = 0.144291, 
    total = 0.144412)), class = "response")
