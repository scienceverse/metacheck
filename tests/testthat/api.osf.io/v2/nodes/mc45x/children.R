structure(list(url = "https://api.osf.io/v2/nodes/mc45x/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Sun, 17 Aug 2025 16:40:48 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    0x7d)), date = structure(1755448848, class = c("POSIXct", 
    "POSIXt"), tzone = "GMT"), times = c(redirect = 0, namelookup = 0, 
    connect = 0, pretransfer = 0.000155, starttransfer = 0.160168, 
    total = 0.160203)), class = "response")
