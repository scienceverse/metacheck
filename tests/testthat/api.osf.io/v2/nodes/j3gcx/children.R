structure(list(url = "https://api.osf.io/v2/nodes/j3gcx/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 16 Dec 2025 23:58:45 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    "list")), all_headers = list(list(status = 200L, version = "HTTP/2", 
        headers = structure(list(server = "nginx", date = "Tue, 16 Dec 2025 23:58:45 GMT", 
    ...
    0x7d)), date = structure(1765929525, class = c("POSIXct", 
    "POSIXt"), tzone = "GMT"), times = c(redirect = 0, namelookup = 0, 
    connect = 0, pretransfer = 0.000122, starttransfer = 0.154847, 
    total = 0.154977)), class = "response")
