structure(list(url = "https://api.osf.io/v2/nodes/ckjef/files/osfstorage/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Sun, 17 Aug 2025 16:31:42 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    "list")), all_headers = list(list(status = 200L, version = "HTTP/2", 
        headers = structure(list(server = "nginx", date = "Sun, 17 Aug 2025 16:31:42 GMT", 
    ...
    0x7d)), date = structure(1755448302, class = c("POSIXct", 
    "POSIXt"), tzone = "GMT"), times = c(redirect = 0, namelookup = 0, 
    connect = 0, pretransfer = 0.000116, starttransfer = 0.174919, 
    total = 0.174961)), class = "response")
