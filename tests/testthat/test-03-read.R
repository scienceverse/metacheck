test_that("exists", {
  ...
  expect_true(is.function(metacheck:::read_xml))
  expect_true(is.function(metacheck:::apa_info))
  expect_true(is.function(metacheck:::apa_authors))
  expect_true(is.function(metacheck:::apa_full_text))
  expect_true(is.function(metacheck:::nlm_info))
  expect_true(is.function(metacheck:::nlm_authors))
  expect_true(is.function(metacheck:::nlm_full_text))
  expect_true(is.function(metacheck:::jats_bib))
  expect_true(is.function(metacheck:::jats_xrefs))
  expect_true(is.function(metacheck:::tei_info))
  expect_true(is.function(metacheck:::tei_authors))
  expect_true(is.function(metacheck:::tei_full_text))
  expect_true(is.function(metacheck:::tei_bib))
  expect_true(is.function(metacheck:::tei_xrefs))
