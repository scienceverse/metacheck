structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/j3gcx/files/osfstorage/685a477d39f9fc4653070521/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 04 Jun 2026 14:53:39 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000132, starttransfer = 0.454766, total = 0.454954
