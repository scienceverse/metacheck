structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/vae8g/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 04 Jun 2026 15:02:34 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.00021, starttransfer = 1.414498, total = 1.414695
