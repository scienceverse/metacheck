structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/jrk3f/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 04 Jun 2026 15:02:31 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000105, starttransfer = 1.684902, total = 1.685158
