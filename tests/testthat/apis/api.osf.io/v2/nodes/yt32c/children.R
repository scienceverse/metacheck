structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/yt32c/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 04 Jun 2026 08:04:13 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.00033, starttransfer = 1.306323, total = 1.306489
