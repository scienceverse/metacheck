structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/cezg3/children/?view_only=f171281f212f4435917b16a9e581a73b", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 04 Jun 2026 08:20:46 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 6.2e-05, starttransfer = 0.683581, total = 0.683708
