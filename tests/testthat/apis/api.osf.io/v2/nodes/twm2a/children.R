structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/twm2a/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 04 Jun 2026 15:02:33 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000215, starttransfer = 1.726488, total = 1.726714
