structure(list(url = "https://api.osf.io/v2/nodes/ckjef/files/osfstorage/", 
    ...
    0x7d)), date = structure(1766965899, class = c("POSIXct", 
    "POSIXt"), tzone = "GMT"), times = c(redirect = 0, namelookup = 0, 
    connect = 0, pretransfer = 0.000253, starttransfer = 0.187748, 
    total = 0.187869)), class = "response")
