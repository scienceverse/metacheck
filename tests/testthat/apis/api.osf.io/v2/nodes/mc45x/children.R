structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/mc45x/children/", 
    ...
    0x7d)), timing = c(redirect = 0, namelookup = 0.002742, connect = 0.016277, 
    pretransfer = 0.035704, starttransfer = 1.216434, total = 1.216572
