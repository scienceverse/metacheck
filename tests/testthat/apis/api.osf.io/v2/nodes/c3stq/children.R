structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/c3stq/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 04 Jun 2026 15:04:48 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000236, starttransfer = 1.309501, total = 1.309687
