structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/m4nbv/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 13 Aug 2026 07:26:28 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000176, starttransfer = 1.588216, total = 1.588574
