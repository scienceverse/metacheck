structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/y6a34/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 13 Aug 2026 07:26:23 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000135, starttransfer = 1.534872, total = 1.534966
