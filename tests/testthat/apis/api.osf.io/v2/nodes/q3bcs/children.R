structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/q3bcs/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 04 Jun 2026 15:04:47 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000137, starttransfer = 1.483045, total = 1.483192
