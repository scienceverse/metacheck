structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/8uqfb/wikis/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 13 Aug 2026 04:51:17 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    0x7d, 0x7d)), timing = c(redirect = 0, namelookup = 0.001954, 
    connect = 0.042693, pretransfer = 0.09903, starttransfer = 0.37794, 
    total = 0.378204), cache = new.env(parent = emptyenv())), class = "httr2_response")
