structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/6nt4v/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 13 Aug 2026 07:27:28 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000132, starttransfer = 1.539213, total = 1.539539
