structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/iywec/children/?view_only=f171281f212f4435917b16a9e581a73b", 
    ...
    pretransfer = 9.5e-05, starttransfer = 0.496257, total = 0.496419
