structure(list(method = "GET", url = "https://api.osf.io/v2/nodes/ybm3c/children/", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Thu, 13 Aug 2026 07:26:24 GMT", `content-type` = "application/vnd.api+json; charset=utf-8", 
    ...
    pretransfer = 0.000132, starttransfer = 1.495678, total = 1.49595
