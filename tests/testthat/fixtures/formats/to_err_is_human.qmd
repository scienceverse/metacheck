...
We conducted a sensitivity power analysis to determine that a Cohen's d of `r d` is the smallest effect size that we could detect with 50 participants in each group and 80% power.
