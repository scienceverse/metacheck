test_that("repo_check offline", {
  ...
  exp <- "We found no links to repositories on the Open Science Framework, Github, ResearchBox, PsychArchives, Zenodo, Dataverse, Figshare, Dryad, ReShare, or 4TU.ResearchData."
