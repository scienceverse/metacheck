...
See [Get Started](articles/metacheck.html) for the basics, [Articles](articles/) for more detailed examples of what you can do, or our [introductory blog post](articles/intro.html) for a more conceptual overview. You can contact the Metacheck team at: [metacheck.scienceverse@gmail.com](mailto:metacheck.scienceverse@gmail.com).
