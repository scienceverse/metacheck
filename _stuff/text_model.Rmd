...
You can use any method for finding the words you want to use in your model, but metacheck has a built-in function to find the words that are most distinctive in your classification groups. The classification values here are 0 and 1, but can be TRUE/FALSE or any two text values.
...
power_log_model <- function(paper) {
  # initial text search
  table <- paper |>
    metacheck::search_text("power(ed)?\\b") |>
    metacheck::search_text("(\\.[0-9]|[0-9]%)")
